            ...
            <div class="row" style="margin-bottom: 60px;">
                ...
                <div class="col-lg-3">
                    <a href="#" data-toggle="modal" data-target="#rendayu"> <!-- untuk data target, lihat modal di bagian bawah-->
                        ...
                        <img class="img-circle center-block" src="img/ph/rendayu.jpg" width="175" height="175" alt="logo">
                    </a>
                ...
                <div class="col-lg-3">
                    <a href="#" data-toggle="modal" data-target="#nurlaila"> <!-- untuk data target, lihat modal di bagian bawah-->
                        ...
                        <img class="img-circle center-block" src="img/ph/nurlaila.jpg" width="175" height="175" alt="logo">
                    </a>
                ...
                <div class="col-lg-3">
                    <a href="#" data-toggle="modal" data-target="#lia-a"> <!-- untuk data target, lihat modal di bagian bawah-->
                        ...
                        <img class="img-circle center-block" src="img/ph/lia-a.jpg" width="175" height="175" alt="logo">
                    </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#ari"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/ari.jpg" width="175" height="175" alt="logo">
                            </a>
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#rizal-d"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/rizal-d.jpg" width="175" height="175" alt="logo">
                            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#azul"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/azul.jpg" width="175" height="175" alt="logo">
                            </a>
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#septa"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/septa.jpg" width="175" height="175" alt="logo">
                            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#juven"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/juven.jpg" width="175" height="175" alt="logo">
                            </a>
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#wahyu"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/wahyu.jpg" width="175" height="175" alt="logo">
                            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#chandra"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/chandra.jpg" width="175" height="175" alt="logo">
                            </a>
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#anisah"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/anisah.jpg" width="175" height="175" alt="logo">
                            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#aryo"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/aryo.jpg" width="175" height="175" alt="logo">
                            </a>
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            <a href="#" data-toggle="modal" data-target="#ibnu"> <!-- untuk data target, lihat modal di bagian bawah-->
                                ...
                                <img class="img-circle center-block" src="img/ph/ibnu.jpg" width="175" height="175" alt="logo">
                            </a>
